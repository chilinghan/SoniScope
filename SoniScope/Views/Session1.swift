...
struct Session1: View {
    @State private var isShowingSession2 = false  // State variable to control navigation
    
    var body: some View {
        NavigationStack {  // Wrap in NavigationStack for navigation capabilities
            ZStack {
                Rectangle()
                ...
                // Make the ZStack a button
                Button(action: {
                    isShowingSession2 = true
                }) {
                    ZStack{
                        Rectangle()
                            .foregroundColor(.clear)
            ...
            .background(.black)
            .navigationDestination(isPresented: $isShowingSession2) {
                Session2() // This will be your Session2 view
