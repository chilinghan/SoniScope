...
lv_obj_remove_flag( cui_batterygroup, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
lv_obj_t *cui_flash;
cui_flash = lv_image_create(cui_batterygroup);
...
lv_obj_remove_flag( cui_flash, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
lv_obj_t ** children = lv_malloc(sizeof(lv_obj_t *) * _UI_COMP_BATTERYGROUP_NUM);
