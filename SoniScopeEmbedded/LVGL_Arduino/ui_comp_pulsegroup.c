...
lv_obj_remove_flag( cui_pulsegroup, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
lv_obj_t *cui_heart;
cui_heart = lv_image_create(cui_pulsegroup);
...
lv_obj_remove_flag( cui_heart, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
lv_obj_t ** children = lv_malloc(sizeof(lv_obj_t *) * _UI_COMP_PULSEGROUP_NUM);
