...
lv_anim_t * BluetoothConnection_Animation( lv_obj_t *TargetObject, int delay);
lv_anim_t * recording_Animation( lv_obj_t *TargetObject, int delay);
lv_anim_t * wavy_Animation( lv_obj_t *TargetObject, int delay);
...
ui_Open_Screen_screen_init();
ui_Recording_Complete_screen_init();
ui_Recording_screen_init();
ui_Sleep_screen_init();
ui_Connected_screen_init();
ui_Recording_Incomplete_screen_init();
ui____initial_actions0 = lv_obj_create(NULL);
lv_disp_load_scr( ui_Open_Screen);
}

void ui_destroy( void )
{ui_Open_Screen_screen_destroy();
ui_Recording_Complete_screen_destroy();
ui_Recording_screen_destroy();
ui_Sleep_screen_destroy();
ui_Connected_screen_destroy();
ui_Recording_Incomplete_screen_destroy();
}
