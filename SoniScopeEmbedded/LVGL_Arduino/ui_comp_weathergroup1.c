...
lv_obj_remove_flag( cui_weathergroup1, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
cui_cloud_fog_1 = lv_image_create(cui_weathergroup1);
...
lv_obj_remove_flag( cui_cloud_fog_1, LV_OBJ_FLAG_SCROLLABLE );    /// Flags

lv_obj_t ** children = lv_malloc(sizeof(lv_obj_t *) * _UI_COMP_WEATHERGROUP1_NUM);
