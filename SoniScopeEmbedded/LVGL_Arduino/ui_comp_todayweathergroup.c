...
lv_obj_remove_flag( cui_todayweathergroup, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
cui_cloud_sun = lv_image_create(cui_todayweathergroup);
...
lv_obj_t ** children = lv_malloc(sizeof(lv_obj_t *) * _UI_COMP_TODAYWEATHERGROUP_NUM);
