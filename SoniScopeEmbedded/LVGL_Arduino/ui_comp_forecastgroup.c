...
lv_obj_remove_flag( cui_forecastgroup, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
lv_label_set_text(cui_day1,"Text");
...
lv_obj_remove_flag( cui_degree_group, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
cui_cloud_sun = lv_image_create(cui_forecastgroup);
...
lv_obj_remove_flag( cui_cloud_sun, LV_OBJ_FLAG_SCROLLABLE );    /// Flags

lv_obj_t ** children = lv_malloc(sizeof(lv_obj_t *) * _UI_COMP_FORECASTGROUP_NUM);
