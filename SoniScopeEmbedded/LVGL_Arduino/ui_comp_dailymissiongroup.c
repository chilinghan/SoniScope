...
lv_obj_remove_flag( cui_dailymissiongroup, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
cui_daily_mission_image = lv_image_create(cui_dailymissiongroup);
...
lv_obj_remove_flag( cui_daily_mission_image, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
lv_obj_t ** children = lv_malloc(sizeof(lv_obj_t *) * _UI_COMP_DAILYMISSIONGROUP_NUM);
