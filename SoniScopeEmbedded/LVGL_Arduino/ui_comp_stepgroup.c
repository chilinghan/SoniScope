...
lv_obj_remove_flag( cui_stepgroup, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
lv_obj_t *cui_step;
cui_step = lv_image_create(cui_stepgroup);
...
lv_obj_remove_flag( cui_step, LV_OBJ_FLAG_SCROLLABLE );    /// Flags
...
lv_obj_t ** children = lv_malloc(sizeof(lv_obj_t *) * _UI_COMP_STEPGROUP_NUM);
